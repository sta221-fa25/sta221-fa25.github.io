...
-   Go to the [sta221-fa25](https://www.github.com/sta221-fa25) organization on GitHub. Click on the repo with the prefix **lab-02**. It contains the starter documents you need to complete the lab.
...
See [Lab 01](/labs/lab01.html) for other matrix operations in R.
:::
