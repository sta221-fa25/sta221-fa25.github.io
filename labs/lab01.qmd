...
-   Go to the course organization at [github.com/sta221-fa25](https://github.com/sta221-fa25) organization on GitHub.
...
-   Click on the green **CODE** button, select **Use SSH** (this might already be selected by default, and if it is, you'll see the text **Clone with SSH**). Click on the clipboard icon to copy the repo URL.
    -   See the [lab 0 instructions](/labs/lab00.html) if you have not set up the SSH key or configured git.
...
-   Access Gradescope through the menu on the [STA 221 Canvas site.](https://canvas.duke.edu/courses/63275)
...
Each assignment will have a portion associated with "Workflow & formatting". This grade is to assess the reproducible workflow and document format. This includes:
