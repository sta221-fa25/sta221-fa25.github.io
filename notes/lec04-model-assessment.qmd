...
ggplot(data = life_exp, aes(x = income_inequality, y = life_exp)) +
  ...
  labs(x = "Income inequality (Gini coefficient)",
       y = "Life expectancy (years )") +
  annotate("text", x = 45, y = 73,  label = "bar(y)", color = "#407E99",
           parse = TRUE, size = 6) +
  theme_bw()
```
...
ggplot(data = life_exp, aes(x = income_inequality, y = life_exp)) +
  ...
  annotate("text", x = 45, y = 73, label = "bar(y)", parse = TRUE, color = "#407E99", size = 6) +
  theme_bw()
```
...
ggplot(data = life_exp, aes(x = income_inequality, y = life_exp)) +
  ...
  labs(x = "Income inequality (Gini coefficient)",
       y = "Life expectancy (years )") +
  annotate("text", x = 45, y = 73, label = "bar(y)", parse = TRUE, color = "#407E99", size = 6)  + 
  annotate("text", x = 45, y = 53, label = "hat(mu)[y]", parse = TRUE, color = "darkred", size = 6) +
  theme_bw()
