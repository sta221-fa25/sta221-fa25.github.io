...
2. interpret coefficients and model fit in context
...
-   `health_expend`: Per capita current spending on healthcare goods and services, expressed in respective currency - international Purchasing Power Parity (PPP) dollar ([from the World Health Organization](https://www.who.int/data/gho/indicator-metadata-registry/imr-details/4952))
...
- The slope coefficient $\beta_1$ is measured in the units of the
