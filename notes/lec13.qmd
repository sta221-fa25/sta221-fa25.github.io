...
-   When the response and predictors are scaled in a particular way, $C_{jj} = VIF_{j}$. [Click here](/notes/variance-inflation-factors.html) to see how.
...
```{r}
#| code-summary: "end of class notes"
#| eval: false
library(tidyverse)
library(tidymodels)
