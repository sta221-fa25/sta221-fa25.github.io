...
Read the abstract of @cessie1992ridge. Read further and identify the objective function that we optimize to find $\hat{\beta}_{logistic-ridge}$.

## Solution

$$
\hat{\beta}_{logistic-ridge} =
\underset{\beta}{\mathrm{argmin}}
~
- l(\beta) + \lambda \beta^T \beta
$$
where $l(\beta)$ is the log-likelihood under the logistic regression model.
