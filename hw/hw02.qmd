...
In all exercises below, you may assume $E[\be] = \bzero$ and $\text{cov}(\be) = \sigma^2 \identity$.
...
Hint: show that $(I-\hatMatrix)$ is orthogonal to $Col(\bX)$. Also note the cyclic property of trace: $tr(ABC) = tr(CAB) = tr(BCA)$ and the fact that $a = tr(a)$ for all scalar numbers $a$.
